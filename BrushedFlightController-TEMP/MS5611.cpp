...
void MS5611::requestTemperature(void)
{
  Wire.beginTransmission(MS5611_ADDRESS);
...
void MS5611::requestPressure(void)
{
  Wire.beginTransmission(MS5611_ADDRESS);
...
{
  raw_temperature = readRegister24(MS5611_CMD_ADC_READ);
...
{
  raw_pressure = readRegister24(MS5611_CMD_ADC_READ);
  return raw_pressure;
  //return readRegister24(MS5611_CMD_ADC_READ);
}

int32_t MS5611::readPressure(uint32_t rawTemperature, bool compensation)
{
...
void MS5611::calculatePressure(int32_t *pressure, int32_t *temperature)
{
